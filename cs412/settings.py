...
SECRET_KEY = 'django-insecure-vph6k6dsl#q%7w76f1fj^_@=(n_v26gbri5-t(ub62)ep#2n7z'
...
ALLOWED_HOSTS = ['cs-412-assignment3-theta.vercel.app',
                ...
                'cs-412-assignment3-677xzednb-graces-projects-168ac535.vercel.app',
...
# Add this line to define the location of your static files
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'quotes/static')]

# For production, you will also need to define STATIC_ROOT
