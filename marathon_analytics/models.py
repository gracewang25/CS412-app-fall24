...
def load_data():
    ...
    filename = '/Users/gracewang/Desktop/2023_chicago_results.csv'
    f = open(filename)
    headers = f.readline() # discard first line containing headers
    ...
    # go through inter file on line at a time
    for line in f:
        fields = line.split(',')
        ...
        try:
            ...
            result.save() # commiting to the db

        except:
            print(f"Exception o     ccurred: {fields}.")
